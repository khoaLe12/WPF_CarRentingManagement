...
public partial class FucarRentingManagementContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.Email, "UQ__Customer__A9D10534E7A6F59F").IsUnique();
    ...
    //protected override void OnConfiguring(DbContextOptionsBuilder options) => options.UseSqlServer("Server=(local);database=FUCarRentingManagement;uid=sa;pwd=12345;TrustServerCertificate=True");
}
